...
namespace HostelApplication.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Change(int Id)
        {
            ...
            User dba = HostelRepository.Users.FirstOrDefault(d => d.EmailAddress == userId);
            return View(dba);
        }
        ...
        public ActionResult Change(User app)
        {
            try
            {
                ...
                var apps = HostelRepository.Users;
                User dba = HostelRepository.Users.FirstOrDefault(d => d.EmailAddress == app.EmailAddress);
